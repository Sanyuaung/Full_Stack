...
class scom extends Model
{
    protected $guarded  =[];
    use HasFactory;
    public static function scom()
    {
        DB::statement(DB::raw('set @row:=0'));
        $scom=DB::select('select substring(Field1,1,3) as recordtype,substring(Field1,4,11) as member_institution,
