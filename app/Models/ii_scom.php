...
class ii_scom extends Model
{
    protected $guarded  =[];
    use HasFactory;
    public static function scom_901902()
    {
        DB::statement(DB::raw('set @row:=0'));
        $scom_901902=DB::select('select substring(Field1,1,3) as recordtype,substring(Field1,4,11) as member_institution,substring(Field1,15,3) as curr_code,
