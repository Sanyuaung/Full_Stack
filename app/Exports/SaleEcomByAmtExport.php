...
class SaleEcomByAmtExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize
{

    /**
     * @return \Illuminate\Support\Collection
     */
    protected $type, $start, $end, $reqamt1, $sign;
    function __construct($type, $start, $end, $reqamt1, $sign)
    {
        $this->start = $start;
        $this->end = $end;
        $this->type = $type;
    ...
    public function collection()
    {
        if ($this->sign == 'gt') {
            return collect(DB::connection('mysql2')
                ...
                where fin.Total_Amt  > $this->reqamt1
