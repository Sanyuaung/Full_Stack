...
@section('content')
    ...
    <a class="float-start ml-15 mb-3" href="{{ route('creditdownload', ['date' => $date]) }}" onclick="return confirm('Are you sure you want to download?')"
        role="button">&nbsp;&nbsp;&nbsp;<span class="iconify" data-icon="ic:sharp-sim-card-download"
            style="color: #d80000;" data-width="25"></span></a>
